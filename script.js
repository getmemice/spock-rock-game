...
function resetAll() {
  ...
  playerSocreEl.textContent = playerScoreNumber
...
function computerRandomChoice() {
  console.log('computerandomChoice')
...
//     canvas.setAttribute("style", "display:flex;z-index:1;pointer-events:none; opacity:0.5");
//     console.log(canvas)
//     console.log(gameContainer)
//     document.body.appendChild(canvas);
//     canvas.appendChild(gameContainer)
//     canvas.width = width;
